...
class DoctorCaseConsultScreen extends StatefulWidget {
  const DoctorCaseConsultScreen({super.key});

  @override
  State<DoctorCaseConsultScreen> createState() =>
      _DoctorCaseConsultScreenState();
}

class _DoctorCaseConsultScreenState extends State<DoctorCaseConsultScreen> {
  final admincontroller = Get.put(AdminController(adminRepo: Get.find()));

  @override
  void initState() {
    super.initState();
    admincontroller.getdoctorcaseconsul();
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Obx(() {
                // Check if loading
                if (admincontroller.doctorcaseconsultloading.value) {
                ...
                if (admincontroller
                    .doctorcaseconsult.value!.data!.cases!.isEmpty) {
