...
class CaseDetailsScreen2 extends StatefulWidget {
  const CaseDetailsScreen2({super.key});

  @override
  State<CaseDetailsScreen2> createState() => _CaseDetailsScreen2State();
}

class _CaseDetailsScreen2State extends State<CaseDetailsScreen2> {
